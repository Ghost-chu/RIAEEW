...
public class HuaniaEarthQuakeCalculator {
    private static final double EARTH_RADIUS = 6378.137d;

    private static final double[] SLOPE = {0.23335281, 0.23347212, 0.23335606, 0.23335613, 0.23335539, 0.23335367, 0.23335291f};

    private static final double[] INTERCEPT = {8.567052, 7.5333714, 6.667651, 8.562906, 7.877903, 7.191011, 6.5055184f};
    ...
    public static double getIntensity(double magnitude, double distance) {
        var log = ((magnitude * 1.363d) + 2.941d) - (Math.log(distance + 7.0d) * 1.494d);
        return log < 0.0f ? 0.0f : log;
    }

    public static double getCountDownSeconds(double depth, double distance) {
    ...
    public static double getDistance(double latitude1, double longitude1, double latitude2, double longitude2) {
        var firstRadLat = Math.toRadians(latitude1);
        var firstRadLng = Math.toRadians(longitude1);
        var secondRadLat = Math.toRadians(latitude2);
        var secondRadLng = Math.toRadians(longitude2);
        ...
        return (double) Math.round(cal * 10000) / 10000;
    }
}
